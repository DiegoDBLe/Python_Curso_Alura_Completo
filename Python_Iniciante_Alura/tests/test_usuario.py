...
def test_deve_subtrair_valor_da_carteira_do_usuario_quando_este_propor_um_lance(diego, leilao):
    diego.propoe_lance(leilao, 50.0)

    assert diego.carteira == 50.0


def test_deve_permitir_propor_lance_quando_o_valor_eh_menor_que_o_valor_da_carteira(diego, leilao):
    diego.propoe_lance(leilao, 1.0)

    assert diego.carteira == 99


def test_deve_permitir_propor_lance_quando_o_valor_eh_igual_ao_valor_da_carteira(diego, leilao):
